...
const (
	// Label holds the string label denoting the basenavstate type in the database.
	Label = "base_nav_state"
	...
	FieldIndex = "index"
	// Table holds the table name of the basenavstate in the database.
	Table = "base_nav_states"
)

// Columns holds all SQL columns for basenavstate fields.
var Columns = []string{
	FieldID,
	FieldCreatedAt,
	FieldDeletedAt,
...
// OrderOption defines the ordering options for the BaseNavState queries.
