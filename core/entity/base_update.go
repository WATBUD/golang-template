...
func (bu *BaseUpdate) SetCreatedAt(t time.Time) *BaseUpdate {
	bu.mutation.SetCreatedAt(t)
	return bu
}

// SetNillableCreatedAt sets the "created_at" field if the given value is not nil.
func (bu *BaseUpdate) SetNillableCreatedAt(t *time.Time) *BaseUpdate {
	if t != nil {
		bu.SetCreatedAt(*t)
	}
	return bu
...
func (bu *BaseUpdate) SetDeletedAt(t time.Time) *BaseUpdate {
	bu.mutation.SetDeletedAt(t)
	return bu
}

// SetNillableDeletedAt sets the "deleted_at" field if the given value is not nil.
func (bu *BaseUpdate) SetNillableDeletedAt(t *time.Time) *BaseUpdate {
	if t != nil {
		bu.SetDeletedAt(*t)
	}
	return bu
...
func (bu *BaseUpdate) SetNillableUpdatedAt(t *time.Time) *BaseUpdate {
	if t != nil {
		bu.SetUpdatedAt(*t)
	}
	return bu
...
// SetCreatedAt sets the "created_at" field.
func (buo *BaseUpdateOne) SetCreatedAt(t time.Time) *BaseUpdateOne {
	buo.mutation.SetCreatedAt(t)
	return buo
}

// SetNillableCreatedAt sets the "created_at" field if the given value is not nil.
func (buo *BaseUpdateOne) SetNillableCreatedAt(t *time.Time) *BaseUpdateOne {
	if t != nil {
		buo.SetCreatedAt(*t)
	}
	return buo
...
// SetDeletedAt sets the "deleted_at" field.
func (buo *BaseUpdateOne) SetDeletedAt(t time.Time) *BaseUpdateOne {
	buo.mutation.SetDeletedAt(t)
	return buo
}

// SetNillableDeletedAt sets the "deleted_at" field if the given value is not nil.
func (buo *BaseUpdateOne) SetNillableDeletedAt(t *time.Time) *BaseUpdateOne {
	if t != nil {
		buo.SetDeletedAt(*t)
	}
	return buo
...
// SetNillableUpdatedAt sets the "updated_at" field if the given value is not nil.
func (buo *BaseUpdateOne) SetNillableUpdatedAt(t *time.Time) *BaseUpdateOne {
	if t != nil {
		buo.SetUpdatedAt(*t)
	}
	return buo
...
func (buo *BaseUpdateOne) sqlSave(ctx context.Context) (_node *Base, err error) {
	...
	if !ok {
		return nil, &ValidationError{Name: "id", err: errors.New(`entity: missing "Base.id" for update`)}
	}
